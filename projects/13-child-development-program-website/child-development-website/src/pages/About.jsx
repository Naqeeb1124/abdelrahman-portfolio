...
const About = () => {
  const founders = [
    ...
    {
      name: 'Jana Ashraf',
      role: 'BSc in Biomedical science',
      education: 'UST Zewail City',
      description: 'Committed to fostering a love for learning and discovery in young minds.',
      image: '/api/placeholder/300/300'
    },
    {
      name: 'Lama Zourob',
      role: 'BSc in Communications and Information engineering',
      education: 'UST Zewail City',
      description: 'Believes in empowering children with the tools to navigate the future.',
      image: '/api/placeholder/300/300'
    },
    {
      name: 'Omar Sharaf',
      role: 'BSc in CSAI - Software development',
      education: 'UST Zewail City',
      description: 'Focused on developing critical thinking and problem-solving skills through engaging activities.',
      image: '/api/placeholder/300/300'
    },
    {
      name: 'Shahd Salim',
      role: 'BSc in Business studies',
      education: 'UST Zewail City',
      description: 'Aims to instill confidence and leadership qualities in every child.',
      image: '/api/placeholder/300/300'
    }
  ];
