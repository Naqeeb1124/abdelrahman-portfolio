...
W_step = 0.1;   % meters (project uses 0.1 m step road disturbance)  :contentReference[oaicite:1]{index=1}
...
% "Given" transfer matrix in the project statement  :contentReference[oaicite:2]{index=2}
...
%% ===========================================
% G1 = (X1 - X2)/U , G2 = (X1 - X2)/W  :contentReference[oaicite:3]{index=3}
G1 = minreal(H11 - H21);
G2 = minreal(H12 - H22);
...
% Requirement: y1 stays within +/-0.1 m and oscillations vanish within 5 s  :contentReference[oaicite:4]{index=4}
%% ===========================================
